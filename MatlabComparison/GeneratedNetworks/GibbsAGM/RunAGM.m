...
function RunAGM(B, Outfile, K, GroundTruth)
...
save(Outfile,'nmi','Sampled_Z','LLvector','ProbAve','time', 'Total_Probability_vs_num_shared_community','AUCvector', 'PerplexityVector', 'TimeVector', 'AUCroc');
